...
const Login = () => {
  ...
  return (
    ...
    className='relative bg-white p-10 rounded-xl text-slate-500'>
       ...
       {state!='Login' && <div className='border px-6 py-2 flex items-center fap-2 rounded-full mt-5'>
            <img src={assets.profile_icon}  alt="" width={25} className='mr-2'/>
        ...
        <div className='border px-6 py-2 flex items-center fap-2 rounded-full mt-4'>
            <img src={assets.email_icon}  alt="" width={18} className='mr-2'/>
        ...
        <div className='border px-6 py-2 flex items-center fap-2 rounded-full mt-4'>
            <img src={assets.lock_icon}  alt="" width={18} className='mr-2'/>
